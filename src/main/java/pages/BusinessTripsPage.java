...
public class BusinessTripsPage extends BasePage {
    ...
    public BusinessTripsPage checkDepartmentField(String text) {
        Assert.assertEquals("Проверка выбранного подразделения", text,
                waitUtilElementToBeVisible(selectedDepartmentField).getText());
        return this;
    }

    public BusinessTripsPage checkHostOrganizationField(String text) {
        Assert.assertEquals("Проверка принимающей организации", text,
